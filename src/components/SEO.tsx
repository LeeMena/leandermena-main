...
interface Props {
  ...
  path?: string
  image?: string
  /** Alt text for the social-share image; pair with a custom `image`. */
  imageAlt?: string
  type?: string
  noindex?: boolean
...
const PERSON_BASE = {
  '@type': 'Person',
  name: 'Leander Mena',
  jobTitle: 'F&B Operations Consultant',
  url: BASE_URL,
  image: DEFAULT_IMAGE,
  address: {
    '@type': 'PostalAddress',
...
function buildSchema(schemaType: SchemaType, url: string, article?: ArticleMeta, description?: string, caseStudy?: Props['caseStudy'], ogImage?: string) {
    ...
    case 'home':
      return [
        ...
        },
        {
          ...
          name: 'Leander Mena - F&B Operations Consulting',
          url: BASE_URL,
          image: OG_DEFAULT_IMAGE,
          description: 'Expert food & beverage operations consulting, pre-opening builds, and operations turnaround for restaurants and hotels nationwide.',
      ...
      return [
        {
          '@context': 'https://schema.org',
          ...PERSON_BASE,
          description: 'Leander Mena is an F&B operations consultant with 18+ years of experience opening and managing restaurants, hotels, and hospitality venues. Forged in Miami, available nationwide.',
          hasOccupation: {
            '@type': 'Occupation',
            name: 'F&B Operations Consultant',
      ...
      return [
        {
          '@context': 'https://schema.org',
          '@type': 'Service',
          name: 'F&B Operations Consulting',
          provider: { ...PERSON_BASE },
          serviceType: 'Food and Beverage Operations Consulting',
          areaServed: AREA_SERVED,
          url: `${BASE_URL}/services`,
          description: 'F&B operations consulting for restaurants and hotels nationwide: operations leadership, menu development, team training, and financial oversight, delivered on-site and remote.',
        },
        SERVICES_FAQ,
        breadcrumb('Services'),
      ]
      ...
      return [
        {
          ...
          mainEntity: {
            '@context': 'https://schema.org',
            ...PERSON_BASE,
            description: 'Leander Mena is a Miami-based F&B operations consultant with 18+ years of experience opening and managing restaurants and hotels.',
            hasCredential: [
      ...
      return [
        {
          ...
          image: OG_DEFAULT_IMAGE,
          description: 'Contact Leander Mena for F&B operations consulting, pre-opening projects, and operations turnaround engagements - available on-site and remote, nationwide.',
          areaServed: AREA_SERVED,
          contactPoint: {
            '@type': 'ContactPoint',
      ...
      return [
        {
          ...
          image: DEFAULT_IMAGE,
          description: 'Miami-based F&B operations consultant with 18+ years opening and running the city’s top restaurants, hotels, and banquet programs. On-site consulting across South Florida.',
      ...
      return [
        {
          ...
          description: 'Hospitality and F&B operations insights from Leander Mena: pre-opening, consulting leadership models, labor cost control, and Miami restaurant strategy.',
        },
        breadcrumb('Insights'),
      ]
    case 'case-studies':
      ...
      return [
        {
          '@context': 'https://schema.org',
          ...PERSON_BASE,
          description: description || 'Leander Mena is a Miami-based F&B operations consultant.',
        },
        breadcrumb('Profile'),
      ]
    case 'article':
...
export default function SEO({ title, description, path = '/', image, imageAlt, type = 'website', noindex = false, schemaType, article, caseStudy }: Props) {
  const url = `${BASE_URL}${path}`
  const ogImage = image || OG_DEFAULT_IMAGE
  const ogAlt = imageAlt || OG_IMAGE_ALT
  ...
  useEffect(() => {
    ...
    setMeta('twitter:image:alt', ogAlt)
    ...
    if (schemaType) {
      ...
      const schemas = buildSchema(schemaType, url, articleMeta, description, caseStudyMeta, ogImage)
  ...
  }, [title, description, url, ogImage, ogAlt, type, noindex, schemaType, articleKey, caseStudyKey])
