...
export const products: Product[] = [
  {
    ...
    description: 'The complete SOP library built and refined across 18+ years in Miami hospitality. Covering opening/closing procedures, service standards, food safety protocols, and team training modules.',
    price: 297,
    originalPrice: 497,
    category: 'template',
    features: [
  ...
  },
  {
    ...
    description: 'The exact system used to open Maska Indian Kitchen + Bar with a Michelin-starred chef and multiple hotel properties. A 120-day roadmap with week-by-week checklists.',
    price: 197,
    originalPrice: 297,
    category: 'playbook',
    features: [
    ...
    badge: 'Most Popular',
    includes: ['120-day roadmap PDF', 'Editable checklists', 'Vendor contact templates', 'Video walkthroughs'],
  },
  {
