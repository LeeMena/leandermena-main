// Insight article metadata - single source of truth for the /insights
// index and the RelatedArticles block on each article page. Ordered
// newest-first (the order the index renders and the order used to pick
...
export const insightPosts = posts

export const insightCategories = [
  'All', 'Labor Cost', 'Pre-Opening', 'Operations', 'Hotel F&B', 'Fractional Leadership',
] as const
